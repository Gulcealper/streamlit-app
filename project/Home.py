...
with col2:
    st.markdown("<h1 style='margin-top: -10px; font-size: 36px; margin-right: 0px;'>Welcome to the North Wyke Farm Platform Meteorological Data Dashboard!</h1>", unsafe_allow_html=True)
